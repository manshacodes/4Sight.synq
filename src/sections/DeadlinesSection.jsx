          ...
          <div className="flex flex-col gap-5">
            ...
            {selected.sources?.length > 0 && (
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-ocean px-5 py-2.5 text-sm font-semibold text-white transition hover:brightness-110 hover:shadow-glow"
              >
                <LinkIcon size={15} />
